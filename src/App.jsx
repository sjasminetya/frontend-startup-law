    ...
    <div className="bg-primary-blue w-full min-h-screen">
      ...
      <div className="grid grid-cols-12 gap-[77px] pb-[216px]">
        ...
        <div className="col-span-6 relative">
          ...
          <img loading="lazy" className="absolute w-[calc(100%-30px)] h-[calc(100%-30px)] top-0 right-0 z-10 rounded-bl-[300px] object-cover" src={IMAGES.BANNER1} alt="banner" />
      ...
      <div className="grid grid-cols-12 gap-[100px] pb-[216px]">
        <div className="col-span-6 relative">
          ...
          <img loading="lazy" className="absolute top-3 right-5 z-10 rounded-[60px] object-cover" src={IMAGES.BANNER2} alt="banner" width={619} height={700} />
